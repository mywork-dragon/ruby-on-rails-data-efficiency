class WelcomeController < ApplicationController
  ...
  def sdk_page
    ...
    @market_share_now = (@market_share_over_time.to_h.values.first.to_f*100) rescue 0
    @market_share_start = (@market_share_over_time.to_h.values.last.to_f*100) rescue 0
