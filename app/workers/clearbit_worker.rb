class ClearbitWorker
  ...
  IOS_DEVELOPER_IDS = {
    ...
    "uservoice.com"=>[249774], "weebly.com"=>[99862], "wordpress.com"=>[58683], "eventbase.com"=>[36734],
  ...
  ANDROID_DEVELOPER_IDS = {
    ...
    "xerox.com"=>[95576], "parker.com"=>[50546], "pg.com"=>[], "kofc.org"=>[794696], "eventbase.com"=>[909548, 104769],
