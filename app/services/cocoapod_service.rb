# Couldn't find any of these methods being used, looks more like a dev utility
...
#       classes_to_dump = [IosSdk, Cocoapod, CocoapodSourceData, IosDevice, IosDeviceFamily, IosDeviceArch, IosDeviceModel] if classes_to_dump.nil?
#
