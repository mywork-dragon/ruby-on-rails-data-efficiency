class LeadHydrationDemoSalesforceService
  ...
  def client
    ...
    @client = Restforce.new :username => 'sfdc_demo@mightysignal.com',
      :password       => 'asfkln2422lkhLKFHSF224',
      :security_token => 'FUbmLMjwqDDm9ihaAw6aajSCk',
      :client_id      => '3MVG9fMtCkV6eLhfOV7PJWSD9DJHoWdJMaBtRo7kFlFW_QEitbUbXe6EXPndh7Dm1kvij9Ljux5SilfAJtNoP',
      :client_secret  => '2243050035072494036'
