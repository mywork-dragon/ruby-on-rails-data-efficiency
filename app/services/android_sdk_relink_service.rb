...
# Couldn't find a place where this class is being used
...
#       end
#
#       AndroidApp.find_in_batches(batch_size: 10000, start: start).with_index do |batch, index|
#         li "App #{index*10000}"
#
...
#     # @author Jason Lew
#
#     # WHAT THE *** IS DOING A SEEDS METHOD IN OTHER PLACE RATHER THAN THE SEEDS????!!
#     def seed
