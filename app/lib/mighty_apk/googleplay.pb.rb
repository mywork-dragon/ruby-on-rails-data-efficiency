...
module MightyApk
  module ProtocolBuffers
    ...
    class AndroidAppDeliveryData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AndroidAppDeliveryData"

      optional :int64, :downloadSize, 1
      optional :string, :signature, 2
      optional :string, :downloadUrl, 3
      repeated ::MightyApk::ProtocolBuffers::AppFileMetadata, :additionalFile, 4
      repeated ::MightyApk::ProtocolBuffers::HttpCookie, :downloadAuthCookie, 5
      ...
      optional ::MightyApk::ProtocolBuffers::AndroidAppPatchData, :patchData, 11
      optional ::MightyApk::ProtocolBuffers::EncryptionParams, :encryptionParams, 12
    end

    class AndroidAppPatchData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AndroidAppPatchData"
    ...
    class AppFileMetadata < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AppFileMetadata"
    ...
    class EncryptionParams < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.EncryptionParams"
    ...
    class HttpCookie < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.HttpCookie"
    ...
    class Address < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Address"
    ...
    class BookAuthor < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BookAuthor"

      optional :string, :name, 1
      optional :string, :deprecatedQuery, 2
      optional ::MightyApk::ProtocolBuffers::Docid, :docid, 3
    end
    ...
    class BookDetails < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BookDetails"

      # nested messages
      class Identifier < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.BookDetails.Identifier"

        optional :int32, :type, 19
        optional :string, :identifier, 20
      end

      repeated ::MightyApk::ProtocolBuffers::BookSubject, :subject, 3
      ...
      repeated ::MightyApk::ProtocolBuffers::BookAuthor, :author, 9
      ...
      repeated ::MightyApk::ProtocolBuffers::BookDetails::Identifier, :identifier, 18, :group => true
    end

    class BookSubject < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BookSubject"
    ...
    class BrowseLink < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BrowseLink"
    ...
    class BrowseResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BrowseResponse"

      optional :string, :contentsUrl, 1
      optional :string, :promoUrl, 2
      repeated ::MightyApk::ProtocolBuffers::BrowseLink, :category, 3
      repeated ::MightyApk::ProtocolBuffers::BrowseLink, :breadcrumb, 4
    end

    class AddressChallenge < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AddressChallenge"

      optional :string, :responseAddressParam, 1
      optional :string, :responseCheckboxesParam, 2
      optional :string, :title, 3
      optional :string, :descriptionHtml, 4
      repeated ::MightyApk::ProtocolBuffers::FormCheckbox, :checkbox, 5
      optional ::MightyApk::ProtocolBuffers::Address, :address, 6
      repeated ::MightyApk::ProtocolBuffers::InputValidationError, :errorInputField, 7
      optional :string, :errorHtml, 8
      repeated :int32, :requiredField, 9
    end

    class AuthenticationChallenge < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AuthenticationChallenge"
    ...
    class BuyResponse < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BuyResponse"
      ...
      class CheckoutInfo < ::ProtocolBuffers::Message
        ...
        set_fully_qualified_name "MightyApk.ProtocolBuffers.BuyResponse.CheckoutInfo"

        # nested messages
        class CheckoutOption < ::ProtocolBuffers::Message
          set_fully_qualified_name "MightyApk.ProtocolBuffers.BuyResponse.CheckoutInfo.CheckoutOption"

          optional :string, :formOfPayment, 6
          optional :string, :encodedAdjustedCart, 7
          optional :string, :instrumentId, 15
          repeated ::MightyApk::ProtocolBuffers::LineItem, :item, 16
          repeated ::MightyApk::ProtocolBuffers::LineItem, :subItem, 17
          optional ::MightyApk::ProtocolBuffers::LineItem, :total, 18
          ...
          optional ::MightyApk::ProtocolBuffers::LineItem, :summary, 33
          repeated :string, :footnoteHtml, 35
          optional ::MightyApk::ProtocolBuffers::Instrument, :instrument, 43
          optional :string, :purchaseCookie, 45
          repeated :string, :disabledReason, 48
        end

        optional ::MightyApk::ProtocolBuffers::LineItem, :item, 3
        repeated ::MightyApk::ProtocolBuffers::LineItem, :subItem, 4
        repeated ::MightyApk::ProtocolBuffers::BuyResponse::CheckoutInfo::CheckoutOption, :checkoutoption, 5, :group => true
        ...
        repeated ::MightyApk::ProtocolBuffers::Instrument, :eligibleInstrument, 44
      end

      optional ::MightyApk::ProtocolBuffers::PurchaseNotificationResponse, :purchaseResponse, 1
      optional ::MightyApk::ProtocolBuffers::BuyResponse::CheckoutInfo, :checkoutinfo, 2, :group => true
    ...
    class Challenge < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Challenge"

      optional ::MightyApk::ProtocolBuffers::AddressChallenge, :addressChallenge, 1
      optional ::MightyApk::ProtocolBuffers::AuthenticationChallenge, :authenticationChallenge, 2
    end

    class FormCheckbox < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.FormCheckbox"
    ...
    class LineItem < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LineItem"

      optional :string, :name, 1
      optional :string, :description, 2
      optional ::MightyApk::ProtocolBuffers::Offer, :offer, 3
      optional ::MightyApk::ProtocolBuffers::Money, :amount, 4
    end

    class Money < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Money"
    ...
    class PurchaseNotificationResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseNotificationResponse"

      optional :int32, :status, 1
      optional ::MightyApk::ProtocolBuffers::DebugInfo, :debugInfo, 2
      optional :string, :localizedErrorMessage, 3
      optional :string, :purchaseId, 4
    end

    class PurchaseStatusResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseStatusResponse"
      ...
      optional ::MightyApk::ProtocolBuffers::LibraryUpdate, :libraryUpdate, 6
      optional ::MightyApk::ProtocolBuffers::Instrument, :rejectedInstrument, 7
      optional ::MightyApk::ProtocolBuffers::AndroidAppDeliveryData, :appDeliveryData, 8
    end

    class CheckInstrumentResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CheckInstrumentResponse"

      optional :bool, :userHasValidInstrument, 1
      optional :bool, :checkoutTokenRequired, 2
      repeated ::MightyApk::ProtocolBuffers::Instrument, :instrument, 4
      repeated ::MightyApk::ProtocolBuffers::Instrument, :eligibleInstrument, 5
    end

    class UpdateInstrumentRequest < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.UpdateInstrumentRequest"

      optional ::MightyApk::ProtocolBuffers::Instrument, :instrument, 1
      optional :string, :checkoutToken, 2
    end

    class UpdateInstrumentResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.UpdateInstrumentResponse"

      optional :int32, :result, 1
      optional :string, :instrumentId, 2
      optional :string, :userMessageHtml, 3
      repeated ::MightyApk::ProtocolBuffers::InputValidationError, :errorInputField, 4
      optional :bool, :checkoutTokenRequired, 5
      optional ::MightyApk::ProtocolBuffers::RedeemedPromoOffer, :redeemedOffer, 6
    end

    class InitiateAssociationResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.InitiateAssociationResponse"

      optional :string, :userToken, 1
    end

    class VerifyAssociationResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.VerifyAssociationResponse"

      optional :int32, :status, 1
      optional ::MightyApk::ProtocolBuffers::Address, :billingAddress, 2
      optional ::MightyApk::ProtocolBuffers::CarrierTos, :carrierTos, 3
    end

    class AddCreditCardPromoOffer < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AddCreditCardPromoOffer"

      optional :string, :headerText, 1
      optional :string, :descriptionHtml, 2
      optional ::MightyApk::ProtocolBuffers::Image, :image, 3
    ...
    class AvailablePromoOffer < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AvailablePromoOffer"

      optional ::MightyApk::ProtocolBuffers::AddCreditCardPromoOffer, :addCreditCardOffer, 1
    end

    class CheckPromoOfferResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CheckPromoOfferResponse"

      repeated ::MightyApk::ProtocolBuffers::AvailablePromoOffer, :availableOffer, 1
      optional ::MightyApk::ProtocolBuffers::RedeemedPromoOffer, :redeemedOffer, 2
      optional :bool, :checkoutTokenRequired, 3
    end

    class RedeemedPromoOffer < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RedeemedPromoOffer"
    ...
    class Docid < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Docid"
    ...
    class Install < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Install"
    ...
    class Offer < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Offer"

      optional :int64, :micros, 1
      optional :string, :currencyCode, 2
      optional :string, :formattedAmount, 3
      repeated ::MightyApk::ProtocolBuffers::Offer, :convertedPrice, 4
      ...
      optional ::MightyApk::ProtocolBuffers::RentalTerms, :rentalTerms, 9
      optional :int64, :onSaleDate, 10
      repeated :string, :promotionLabel, 11
      optional ::MightyApk::ProtocolBuffers::SubscriptionTerms, :subscriptionTerms, 12
      optional :string, :formattedName, 13
      optional :string, :formattedDescription, 14
    end

    class OwnershipInfo < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.OwnershipInfo"
    ...
    class RentalTerms < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RentalTerms"
    ...
    class SubscriptionTerms < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SubscriptionTerms"

      optional ::MightyApk::ProtocolBuffers::TimePeriod, :recurringPeriod, 1
      optional ::MightyApk::ProtocolBuffers::TimePeriod, :trialPeriod, 2
    end

    class TimePeriod < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.TimePeriod"
    ...
    class BillingAddressSpec < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BillingAddressSpec"
    ...
    class CarrierBillingCredentials < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CarrierBillingCredentials"
    ...
    class CarrierBillingInstrument < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CarrierBillingInstrument"
      ...
      optional ::MightyApk::ProtocolBuffers::EncryptedSubscriberInfo, :encryptedSubscriberInfo, 6
      optional ::MightyApk::ProtocolBuffers::CarrierBillingCredentials, :credentials, 7
      optional ::MightyApk::ProtocolBuffers::CarrierTos, :acceptedCarrierTos, 8
    end

    class CarrierBillingInstrumentStatus < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CarrierBillingInstrumentStatus"

      optional ::MightyApk::ProtocolBuffers::CarrierTos, :carrierTos, 1
      optional :bool, :associationRequired, 2
      optional :bool, :passwordRequired, 3
      optional ::MightyApk::ProtocolBuffers::PasswordPrompt, :carrierPasswordPrompt, 4
      optional :int32, :apiVersion, 5
      optional :string, :name, 6
    end

    class CarrierTos < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CarrierTos"

      optional ::MightyApk::ProtocolBuffers::CarrierTosEntry, :dcbTos, 1
      optional ::MightyApk::ProtocolBuffers::CarrierTosEntry, :piiTos, 2
      optional :bool, :needsDcbTosAcceptance, 3
      optional :bool, :needsPiiTosAcceptance, 4
    end

    class CarrierTosEntry < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CarrierTosEntry"
    ...
    class CreditCardInstrument < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CreditCardInstrument"
      ...
      repeated ::MightyApk::ProtocolBuffers::EfeParam, :escrowEfeParam, 6
    end

    class EfeParam < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.EfeParam"
    ...
    class InputValidationError < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.InputValidationError"
    ...
    class Instrument < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Instrument"

      optional :string, :instrumentId, 1
      optional ::MightyApk::ProtocolBuffers::Address, :billingAddress, 2
      optional ::MightyApk::ProtocolBuffers::CreditCardInstrument, :creditCard, 3
      optional ::MightyApk::ProtocolBuffers::CarrierBillingInstrument, :carrierBilling, 4
      optional ::MightyApk::ProtocolBuffers::BillingAddressSpec, :billingAddressSpec, 5
      optional :int32, :instrumentFamily, 6
      optional ::MightyApk::ProtocolBuffers::CarrierBillingInstrumentStatus, :carrierBillingStatus, 7
      optional :string, :displayTitle, 8
    end

    class PasswordPrompt < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PasswordPrompt"
    ...
    class ContainerMetadata < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ContainerMetadata"
    ...
    class FlagContentResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.FlagContentResponse"
    ...
    class DebugInfo < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DebugInfo"

      # nested messages
      class Timing < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.DebugInfo.Timing"
      ...
      repeated ::MightyApk::ProtocolBuffers::DebugInfo::Timing, :timing, 2, :group => true
    end

    class DeliveryResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DeliveryResponse"

      optional :int32, :status, 1
      optional ::MightyApk::ProtocolBuffers::AndroidAppDeliveryData, :appDeliveryData, 2
    end

    class BulkDetailsEntry < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BulkDetailsEntry"

      optional ::MightyApk::ProtocolBuffers::DocV2, :doc, 1
    end

    class BulkDetailsRequest < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BulkDetailsRequest"
    ...
    class BulkDetailsResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BulkDetailsResponse"
    ...
    class DetailsResponse < ::ProtocolBuffers::Message
      ...
      optional ::MightyApk::ProtocolBuffers::DocV1, :docV1, 1
    ...
    class DeviceConfigurationProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DeviceConfigurationProto"
    ...
    class Document < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Document"

      optional ::MightyApk::ProtocolBuffers::Docid, :docid, 1
      optional ::MightyApk::ProtocolBuffers::Docid, :fetchDocid, 2
      optional ::MightyApk::ProtocolBuffers::Docid, :sampleDocid, 3
      optional :string, :title, 4
      optional :string, :url, 5
      repeated :string, :snippet, 6
      optional ::MightyApk::ProtocolBuffers::Offer, :priceDeprecated, 7
      optional ::MightyApk::ProtocolBuffers::Availability, :availability, 9
      repeated ::MightyApk::ProtocolBuffers::Image, :image, 10
      repeated ::MightyApk::ProtocolBuffers::Document, :child, 11
      optional ::MightyApk::ProtocolBuffers::AggregateRating, :aggregateRating, 13
      repeated ::MightyApk::ProtocolBuffers::Offer, :offer, 14
      repeated ::MightyApk::ProtocolBuffers::TranslatedText, :translatedSnippet, 15
      repeated ::MightyApk::ProtocolBuffers::DocumentVariant, :documentVariant, 16
      repeated :string, :categoryId, 17
      repeated ::MightyApk::ProtocolBuffers::Document, :decoration, 18
      repeated ::MightyApk::ProtocolBuffers::Document, :parent, 19
      optional :string, :privacyPolicyUrl, 20
    end

    class DocumentVariant < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DocumentVariant"

      optional :int32, :variationType, 1
      optional ::MightyApk::ProtocolBuffers::Rule, :rule, 2
      optional :string, :title, 3
      repeated :string, :snippet, 4
      optional :string, :recentChanges, 5
      repeated ::MightyApk::ProtocolBuffers::TranslatedText, :autoTranslation, 6
      repeated ::MightyApk::ProtocolBuffers::Offer, :offer, 7
      optional :int64, :channelId, 9
      repeated ::MightyApk::ProtocolBuffers::Document, :child, 10
      repeated ::MightyApk::ProtocolBuffers::Document, :decoration, 11
    end
    ...
    class Image < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Image"

      # nested messages
      class Dimension < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.Image.Dimension"
      ...
      class Citation < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.Image.Citation"
      ...
      optional ::MightyApk::ProtocolBuffers::Image::Dimension, :dimension, 2, :group => true
      ...
      optional ::MightyApk::ProtocolBuffers::Image::Citation, :citation, 10, :group => true
    end

    class TranslatedText < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.TranslatedText"
    ...
    class Badge < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Badge"

      optional :string, :title, 1
      repeated ::MightyApk::ProtocolBuffers::Image, :image, 2
      optional :string, :browseUrl, 3
    end

    class ContainerWithBanner < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ContainerWithBanner"

      optional :string, :colorThemeArgb, 1
    end

    class DealOfTheDay < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DealOfTheDay"
    ...
    class EditorialSeriesContainer < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.EditorialSeriesContainer"
    ...
    class Link < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Link"

      optional :string, :uri, 1
    end

    class PlusOneData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PlusOneData"

      optional :bool, :setByUser, 1
      optional :int64, :total, 2
      optional :int64, :circlesTotal, 3
      repeated ::MightyApk::ProtocolBuffers::PlusPerson, :circlesPeople, 4
    end

    class PlusPerson < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PlusPerson"
    ...
    class PromotedDoc < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PromotedDoc"

      optional :string, :title, 1
      optional :string, :subtitle, 2
      repeated ::MightyApk::ProtocolBuffers::Image, :image, 3
      optional :string, :descriptionHtml, 4
      optional :string, :detailsUrl, 5
    end

    class Reason < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Reason"
    ...
    class SectionMetadata < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SectionMetadata"
    ...
    class SeriesAntenna < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SeriesAntenna"
      ...
      optional :string, :episodeSubtitle, 4
      optional :string, :colorThemeArgb, 5
      optional ::MightyApk::ProtocolBuffers::SectionMetadata, :sectionTracks, 6
      optional ::MightyApk::ProtocolBuffers::SectionMetadata, :sectionAlbums, 7
    end

    class Template < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Template"

      optional ::MightyApk::ProtocolBuffers::SeriesAntenna, :seriesAntenna, 1
      optional ::MightyApk::ProtocolBuffers::TileTemplate, :tileGraphic2X1, 2
      optional ::MightyApk::ProtocolBuffers::TileTemplate, :tileGraphic4X2, 3
      optional ::MightyApk::ProtocolBuffers::TileTemplate, :tileGraphicColoredTitle2X1, 4
      optional ::MightyApk::ProtocolBuffers::TileTemplate, :tileGraphicUpperLeftTitle2X1, 5
      optional ::MightyApk::ProtocolBuffers::TileTemplate, :tileDetailsReflectedGraphic2X2, 6
      optional ::MightyApk::ProtocolBuffers::TileTemplate, :tileFourBlock4X2, 7
      optional ::MightyApk::ProtocolBuffers::ContainerWithBanner, :containerWithBanner, 8
      optional ::MightyApk::ProtocolBuffers::DealOfTheDay, :dealOfTheDay, 9
      optional ::MightyApk::ProtocolBuffers::TileTemplate, :tileGraphicColoredTitle4X2, 10
      optional ::MightyApk::ProtocolBuffers::EditorialSeriesContainer, :editorialSeriesContainer, 11
    end

    class TileTemplate < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.TileTemplate"
    ...
    class Warning < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Warning"

      optional :string, :localizedMessage, 1
    end

    class AlbumDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AlbumDetails"

      optional :string, :name, 1
      optional ::MightyApk::ProtocolBuffers::MusicDetails, :details, 2
      optional ::MightyApk::ProtocolBuffers::ArtistDetails, :displayArtist, 3
    end

    class AppDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AppDetails"
      ...
      repeated ::MightyApk::ProtocolBuffers::FileMetadata, :file, 17
      optional :string, :appType, 18
    end

    class ArtistDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ArtistDetails"

      optional :string, :detailsUrl, 1
      optional :string, :name, 2
      optional ::MightyApk::ProtocolBuffers::ArtistExternalLinks, :externalLinks, 3
    end

    class ArtistExternalLinks < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ArtistExternalLinks"
    ...
    class DocumentDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DocumentDetails"

      optional ::MightyApk::ProtocolBuffers::AppDetails, :appDetails, 1
      optional ::MightyApk::ProtocolBuffers::AlbumDetails, :albumDetails, 2
      optional ::MightyApk::ProtocolBuffers::ArtistDetails, :artistDetails, 3
      optional ::MightyApk::ProtocolBuffers::SongDetails, :songDetails, 4
      optional ::MightyApk::ProtocolBuffers::BookDetails, :bookDetails, 5
      optional ::MightyApk::ProtocolBuffers::VideoDetails, :videoDetails, 6
      optional ::MightyApk::ProtocolBuffers::SubscriptionDetails, :subscriptionDetails, 7
      optional ::MightyApk::ProtocolBuffers::MagazineDetails, :magazineDetails, 8
      optional ::MightyApk::ProtocolBuffers::TvShowDetails, :tvShowDetails, 9
      optional ::MightyApk::ProtocolBuffers::TvSeasonDetails, :tvSeasonDetails, 10
      optional ::MightyApk::ProtocolBuffers::TvEpisodeDetails, :tvEpisodeDetails, 11
    end

    class FileMetadata < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.FileMetadata"
    ...
    class MagazineDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.MagazineDetails"
    ...
    class MusicDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.MusicDetails"

      optional :int32, :censoring, 1
      optional :int32, :durationSec, 2
      optional :string, :originalReleaseDate, 3
      optional :string, :label, 4
      repeated ::MightyApk::ProtocolBuffers::ArtistDetails, :artist, 5
    ...
    class SongDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SongDetails"
      ...
      optional ::MightyApk::ProtocolBuffers::ArtistDetails, :displayArtist, 6
    end

    class SubscriptionDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SubscriptionDetails"

      optional :int32, :subscriptionPeriod, 1
    end

    class Trailer < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Trailer"
    ...
    class TvEpisodeDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.TvEpisodeDetails"
    ...
    class TvSeasonDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.TvSeasonDetails"
    ...
    class TvShowDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.TvShowDetails"
    ...
    class VideoCredit < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.VideoCredit"
    ...
    class VideoDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.VideoDetails"

      repeated ::MightyApk::ProtocolBuffers::VideoCredit, :credit, 1
      ...
      repeated ::MightyApk::ProtocolBuffers::Trailer, :trailer, 8
      repeated ::MightyApk::ProtocolBuffers::VideoRentalTerm, :rentalTerm, 9
    end
    ...
    class VideoRentalTerm < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.VideoRentalTerm"

      # nested messages
      class Term < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.VideoRentalTerm.Term"
      ...
      repeated ::MightyApk::ProtocolBuffers::VideoRentalTerm::Term, :term, 4, :group => true
    end

    class Bucket < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Bucket"

      repeated ::MightyApk::ProtocolBuffers::DocV1, :document, 1
    ...
    class ListResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ListResponse"

      repeated ::MightyApk::ProtocolBuffers::Bucket, :bucket, 1
      repeated ::MightyApk::ProtocolBuffers::DocV2, :doc, 2
    end

    class DocV1 < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DocV1"

      optional ::MightyApk::ProtocolBuffers::Document, :finskyDoc, 1
      ...
      optional ::MightyApk::ProtocolBuffers::DocumentDetails, :details, 9
      ...
      optional ::MightyApk::ProtocolBuffers::PlusOneData, :plusOneData, 16
    ...
    class Annotations < ::ProtocolBuffers::Message
      ...
      optional ::MightyApk::ProtocolBuffers::SectionMetadata, :sectionRelated, 1
      optional ::MightyApk::ProtocolBuffers::SectionMetadata, :sectionMoreBy, 2
      optional ::MightyApk::ProtocolBuffers::PlusOneData, :plusOneData, 3
      repeated ::MightyApk::ProtocolBuffers::Warning, :warning, 4
      optional ::MightyApk::ProtocolBuffers::SectionMetadata, :sectionBodyOfWork, 5
      optional ::MightyApk::ProtocolBuffers::SectionMetadata, :sectionCoreContent, 6
      optional ::MightyApk::ProtocolBuffers::Template, :template, 7
      repeated ::MightyApk::ProtocolBuffers::Badge, :badgeForCreator, 8
      repeated ::MightyApk::ProtocolBuffers::Badge, :badgeForDoc, 9
      optional ::MightyApk::ProtocolBuffers::Link, :link, 10
      optional ::MightyApk::ProtocolBuffers::SectionMetadata, :sectionCrossSell, 11
      optional ::MightyApk::ProtocolBuffers::SectionMetadata, :sectionRelatedDocType, 12
      repeated ::MightyApk::ProtocolBuffers::PromotedDoc, :promotedDoc, 13
    ...
    class DocV2 < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DocV2"
      ...
      repeated ::MightyApk::ProtocolBuffers::Offer, :offer, 8
      optional ::MightyApk::ProtocolBuffers::Availability, :availability, 9
      repeated ::MightyApk::ProtocolBuffers::Image, :image, 10
      repeated ::MightyApk::ProtocolBuffers::DocV2, :child, 11
      optional ::MightyApk::ProtocolBuffers::ContainerMetadata, :containerMetadata, 12
      optional ::MightyApk::ProtocolBuffers::DocumentDetails, :details, 13
      optional ::MightyApk::ProtocolBuffers::AggregateRating, :aggregateRating, 14
      optional ::MightyApk::ProtocolBuffers::Annotations, :annotations, 15
    ...
    class EncryptedSubscriberInfo < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.EncryptedSubscriberInfo"
    ...
    class Availability < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Availability"

      # nested messages
      class PerDeviceAvailabilityRestriction < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.Availability.PerDeviceAvailabilityRestriction"

        optional :fixed64, :androidId, 10
        optional :int32, :deviceRestriction, 11
        optional :int64, :channelId, 12
        optional ::MightyApk::ProtocolBuffers::FilterEvaluationInfo, :filterInfo, 15
      end

      optional :int32, :restriction, 5
      optional :int32, :offerType, 6
      optional ::MightyApk::ProtocolBuffers::Rule, :rule, 7
      repeated ::MightyApk::ProtocolBuffers::Availability::PerDeviceAvailabilityRestriction, :perdeviceavailabilityrestriction, 9, :group => true
      optional :bool, :availableIfOwned, 13
      repeated ::MightyApk::ProtocolBuffers::Install, :install, 14
      optional ::MightyApk::ProtocolBuffers::FilterEvaluationInfo, :filterInfo, 16
      optional ::MightyApk::ProtocolBuffers::OwnershipInfo, :ownershipInfo, 17
    end

    class FilterEvaluationInfo < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.FilterEvaluationInfo"

      repeated ::MightyApk::ProtocolBuffers::RuleEvaluation, :ruleEvaluation, 1
    end

    class Rule < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Rule"
      ...
      repeated ::MightyApk::ProtocolBuffers::Rule, :subrule, 7
    ...
    class RuleEvaluation < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RuleEvaluation"

      optional ::MightyApk::ProtocolBuffers::Rule, :rule, 1
    ...
    class LibraryAppDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LibraryAppDetails"
    ...
    class LibraryMutation < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LibraryMutation"

      optional ::MightyApk::ProtocolBuffers::Docid, :docid, 1
      optional :int32, :offerType, 2
      optional :int64, :documentHash, 3
      optional :bool, :deleted, 4
      optional ::MightyApk::ProtocolBuffers::LibraryAppDetails, :appDetails, 5
      optional ::MightyApk::ProtocolBuffers::LibrarySubscriptionDetails, :subscriptionDetails, 6
    end

    class LibrarySubscriptionDetails < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LibrarySubscriptionDetails"
    ...
    class LibraryUpdate < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LibraryUpdate"

      optional :int32, :status, 1
      optional :int32, :corpus, 2
      optional :bytes, :serverToken, 3
      repeated ::MightyApk::ProtocolBuffers::LibraryMutation, :mutation, 4
      optional :bool, :hasMore, 5
      optional :string, :libraryId, 6
    end

    class ClientLibraryState < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ClientLibraryState"
    ...
    class LibraryReplicationRequest < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LibraryReplicationRequest"

      repeated ::MightyApk::ProtocolBuffers::ClientLibraryState, :libraryState, 1
    end

    class LibraryReplicationResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LibraryReplicationResponse"

      repeated ::MightyApk::ProtocolBuffers::LibraryUpdate, :update, 1
    end

    class ClickLogEvent < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ClickLogEvent"
    ...
    class LogRequest < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LogRequest"

      repeated ::MightyApk::ProtocolBuffers::ClickLogEvent, :clickEvent, 1
    end

    class LogResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LogResponse"

    end

    class AndroidAppNotificationData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AndroidAppNotificationData"
    ...
    class InAppNotificationData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.InAppNotificationData"
    ...
    class LibraryDirtyData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.LibraryDirtyData"

      optional :int32, :backend, 1
    end

    class Notification < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Notification"

      optional :int32, :notificationType, 1
      optional :int64, :timestamp, 3
      optional ::MightyApk::ProtocolBuffers::Docid, :docid, 4
      optional :string, :docTitle, 5
      optional :string, :userEmail, 6
      optional ::MightyApk::ProtocolBuffers::AndroidAppNotificationData, :appData, 7
      optional ::MightyApk::ProtocolBuffers::AndroidAppDeliveryData, :appDeliveryData, 8
      optional ::MightyApk::ProtocolBuffers::PurchaseRemovalData, :purchaseRemovalData, 9
      optional ::MightyApk::ProtocolBuffers::UserNotificationData, :userNotificationData, 10
      optional ::MightyApk::ProtocolBuffers::InAppNotificationData, :inAppNotificationData, 11
      optional ::MightyApk::ProtocolBuffers::PurchaseDeclinedData, :purchaseDeclinedData, 12
      optional :string, :notificationId, 13
      optional ::MightyApk::ProtocolBuffers::LibraryUpdate, :libraryUpdate, 14
      optional ::MightyApk::ProtocolBuffers::LibraryDirtyData, :libraryDirtyData, 15
    end

    class PurchaseDeclinedData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseDeclinedData"
    ...
    class PurchaseRemovalData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseRemovalData"

      optional :bool, :malicious, 1
    end

    class UserNotificationData < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.UserNotificationData"
    ...
    class PlusOneResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PlusOneResponse"

    end

    class RateSuggestedContentResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RateSuggestedContentResponse"

    end

    class AggregateRating < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AggregateRating"
    ...
    class DirectPurchase < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DirectPurchase"
    ...
    class ResolveLinkResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ResolveLinkResponse"

      optional :string, :detailsUrl, 1
      optional :string, :browseUrl, 2
      optional :string, :searchUrl, 3
      optional ::MightyApk::ProtocolBuffers::DirectPurchase, :directPurchase, 4
      optional :string, :homeUrl, 5
    end

    class Payload < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Payload"

      optional ::MightyApk::ProtocolBuffers::ListResponse, :listResponse, 1
      optional ::MightyApk::ProtocolBuffers::DetailsResponse, :detailsResponse, 2
      optional ::MightyApk::ProtocolBuffers::ReviewResponse, :reviewResponse, 3
      optional ::MightyApk::ProtocolBuffers::BuyResponse, :buyResponse, 4
      optional ::MightyApk::ProtocolBuffers::SearchResponse, :searchResponse, 5
      optional ::MightyApk::ProtocolBuffers::TocResponse, :tocResponse, 6
      optional ::MightyApk::ProtocolBuffers::BrowseResponse, :browseResponse, 7
      optional ::MightyApk::ProtocolBuffers::PurchaseStatusResponse, :purchaseStatusResponse, 8
      optional ::MightyApk::ProtocolBuffers::UpdateInstrumentResponse, :updateInstrumentResponse, 9
      optional ::MightyApk::ProtocolBuffers::LogResponse, :logResponse, 10
      optional ::MightyApk::ProtocolBuffers::CheckInstrumentResponse, :checkInstrumentResponse, 11
      optional ::MightyApk::ProtocolBuffers::PlusOneResponse, :plusOneResponse, 12
      optional ::MightyApk::ProtocolBuffers::FlagContentResponse, :flagContentResponse, 13
      optional ::MightyApk::ProtocolBuffers::AckNotificationResponse, :ackNotificationResponse, 14
      optional ::MightyApk::ProtocolBuffers::InitiateAssociationResponse, :initiateAssociationResponse, 15
      optional ::MightyApk::ProtocolBuffers::VerifyAssociationResponse, :verifyAssociationResponse, 16
      optional ::MightyApk::ProtocolBuffers::LibraryReplicationResponse, :libraryReplicationResponse, 17
      optional ::MightyApk::ProtocolBuffers::RevokeResponse, :revokeResponse, 18
      optional ::MightyApk::ProtocolBuffers::BulkDetailsResponse, :bulkDetailsResponse, 19
      optional ::MightyApk::ProtocolBuffers::ResolveLinkResponse, :resolveLinkResponse, 20
      optional ::MightyApk::ProtocolBuffers::DeliveryResponse, :deliveryResponse, 21
      optional ::MightyApk::ProtocolBuffers::AcceptTosResponse, :acceptTosResponse, 22
      optional ::MightyApk::ProtocolBuffers::RateSuggestedContentResponse, :rateSuggestedContentResponse, 23
      optional ::MightyApk::ProtocolBuffers::CheckPromoOfferResponse, :checkPromoOfferResponse, 24
    end

    class PreFetch < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PreFetch"
    ...
    class ResponseWrapper < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ResponseWrapper"

      optional ::MightyApk::ProtocolBuffers::Payload, :payload, 1
      optional ::MightyApk::ProtocolBuffers::ServerCommands, :commands, 2
      repeated ::MightyApk::ProtocolBuffers::PreFetch, :preFetch, 3
      repeated ::MightyApk::ProtocolBuffers::Notification, :notification, 4
    end

    class ServerCommands < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ServerCommands"
    ...
    class GetReviewsResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetReviewsResponse"

      repeated ::MightyApk::ProtocolBuffers::Review, :review, 1
      optional :int64, :matchingCount, 2
    end

    class Review < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Review"
    ...
    class ReviewResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ReviewResponse"

      optional ::MightyApk::ProtocolBuffers::GetReviewsResponse, :getResponse, 1
      optional :string, :nextPageUrl, 2
    end

    class RevokeResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RevokeResponse"

      optional ::MightyApk::ProtocolBuffers::LibraryUpdate, :libraryUpdate, 1
    end

    class RelatedSearch < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RelatedSearch"
    ...
    class SearchResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SearchResponse"

      optional :string, :originalQuery, 1
      optional :string, :suggestedQuery, 2
      optional :bool, :aggregateQuery, 3
      repeated ::MightyApk::ProtocolBuffers::Bucket, :bucket, 4
      repeated ::MightyApk::ProtocolBuffers::DocV2, :doc, 5
      repeated ::MightyApk::ProtocolBuffers::RelatedSearch, :relatedSearch, 6
    end

    class CorpusMetadata < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CorpusMetadata"
    ...
    class Experiments < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.Experiments"

      repeated :string, :experimentId, 1
    end

    class TocResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.TocResponse"

      repeated ::MightyApk::ProtocolBuffers::CorpusMetadata, :corpus, 1
      optional :int32, :tosVersionDeprecated, 2
      optional :string, :tosContent, 3
      optional :string, :homeUrl, 4
      optional ::MightyApk::ProtocolBuffers::Experiments, :experiments, 5
      optional :string, :tosCheckboxTextMarketingEmails, 6
      optional :string, :tosToken, 7
      optional ::MightyApk::ProtocolBuffers::UserSettings, :userSettings, 8
      optional :string, :iconOverrideUrl, 9
    end

    class UserSettings < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.UserSettings"

      optional :bool, :tosCheckboxMarketingEmailsOptedIn, 1
    end

    class AcceptTosResponse < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AcceptTosResponse"

    end

    class AckNotificationsRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AckNotificationsRequestProto"

      repeated :string, :notificationId, 1
      optional ::MightyApk::ProtocolBuffers::SignatureHashProto, :signatureHash, 2
      repeated :string, :nackNotificationId, 3
    end

    class AckNotificationsResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AckNotificationsResponseProto"

    end

    class AddressProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AddressProto"
    ...
    class AppDataProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AppDataProto"
    ...
    class AppSuggestionProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AppSuggestionProto"

      optional ::MightyApk::ProtocolBuffers::ExternalAssetProto, :assetInfo, 1
    end

    class AssetIdentifierProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AssetIdentifierProto"
    ...
    class AssetsRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AssetsRequestProto"
    ...
    class AssetsResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.AssetsResponseProto"

      repeated ::MightyApk::ProtocolBuffers::ExternalAssetProto, :asset, 1
      optional :int64, :numTotalEntries, 2
      optional :string, :correctedQuery, 3
      repeated ::MightyApk::ProtocolBuffers::ExternalAssetProto, :altAsset, 4
    ...
    class BillingEventRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BillingEventRequestProto"
      ...
      optional ::MightyApk::ProtocolBuffers::ExternalCarrierBillingInstrumentProto, :carrierInstrument, 5
    end

    class BillingEventResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BillingEventResponseProto"

    end

    class BillingParameterProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.BillingParameterProto"
    ...
    class CarrierBillingCredentialsProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CarrierBillingCredentialsProto"
    ...
    class CategoryProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CategoryProto"
      ...
      repeated ::MightyApk::ProtocolBuffers::CategoryProto, :subCategories, 8
    ...
    class CheckForNotificationsRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CheckForNotificationsRequestProto"

      optional :int64, :alarmDuration, 1
    end

    class CheckForNotificationsResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CheckForNotificationsResponseProto"

    end

    class CheckLicenseRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CheckLicenseRequestProto"
    ...
    class CheckLicenseResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CheckLicenseResponseProto"
    ...
    class CommentsRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CommentsRequestProto"
    ...
    class CommentsResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.CommentsResponseProto"

      repeated ::MightyApk::ProtocolBuffers::ExternalCommentProto, :comment, 1
      optional :int64, :numTotalEntries, 2
      optional ::MightyApk::ProtocolBuffers::ExternalCommentProto, :selfComment, 3
    end
    ...
    class ContentSyncRequestProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ContentSyncRequestProto"

      # nested messages
      class AssetInstallState < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.ContentSyncRequestProto.AssetInstallState"
      ...
      class SystemApp < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.ContentSyncRequestProto.SystemApp"
      ...
      repeated ::MightyApk::ProtocolBuffers::ContentSyncRequestProto::AssetInstallState, :assetinstallstate, 2, :group => true
      repeated ::MightyApk::ProtocolBuffers::ContentSyncRequestProto::SystemApp, :systemapp, 10, :group => true
      optional :int32, :sideloadedAppCount, 14
    end

    class ContentSyncResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ContentSyncResponseProto"

      optional :int32, :numUpdatesAvailable, 1
    end

    class DataMessageProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DataMessageProto"

      optional :string, :category, 1
      repeated ::MightyApk::ProtocolBuffers::AppDataProto, :appData, 3
    end

    class DownloadInfoProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.DownloadInfoProto"

      optional :int64, :apkSize, 1
      repeated ::MightyApk::ProtocolBuffers::FileMetadataProto, :additionalFile, 2
    end
    ...
    class ExternalAssetProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalAssetProto"

      # nested messages
      class PurchaseInformation < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalAssetProto.PurchaseInformation"
      ...
      class ExtendedInfo < ::ProtocolBuffers::Message
        ...
        set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalAssetProto.ExtendedInfo"

        # nested messages
        class PackageDependency < ::ProtocolBuffers::Message
          set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalAssetProto.ExtendedInfo.PackageDependency"
        ...
        repeated ::MightyApk::ProtocolBuffers::ExternalAssetProto::ExtendedInfo::PackageDependency, :packagedependency, 39, :group => true
        optional :string, :videoLink, 43
        optional ::MightyApk::ProtocolBuffers::DownloadInfoProto, :downloadInfo, 49
      end
      ...
      optional ::MightyApk::ProtocolBuffers::ExternalAssetProto::PurchaseInformation, :purchaseinformation, 9, :group => true
      optional ::MightyApk::ProtocolBuffers::ExternalAssetProto::ExtendedInfo, :extendedinfo, 12, :group => true
      ...
      repeated ::MightyApk::ProtocolBuffers::ExternalBadgeProto, :appBadge, 47
      repeated ::MightyApk::ProtocolBuffers::ExternalBadgeProto, :ownerBadge, 48
    end

    class ExternalBadgeImageProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalBadgeImageProto"
    ...
    class ExternalBadgeProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalBadgeProto"

      optional :string, :localizedTitle, 1
      optional :string, :localizedDescription, 2
      repeated ::MightyApk::ProtocolBuffers::ExternalBadgeImageProto, :badgeImage, 3
      optional :string, :searchId, 4
    end

    class ExternalCarrierBillingInstrumentProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalCarrierBillingInstrumentProto"
      ...
      optional ::MightyApk::ProtocolBuffers::EncryptedSubscriberInfo, :encryptedSubscriberInfo, 13
    end

    class ExternalCommentProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalCommentProto"
    ...
    class ExternalCreditCard < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalCreditCard"
    ...
    class ExternalPaypalInstrumentProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ExternalPaypalInstrumentProto"

      optional :string, :instrumentKey, 1
      optional :string, :preapprovalKey, 2
      optional :string, :paypalEmail, 3
      optional ::MightyApk::ProtocolBuffers::AddressProto, :paypalAddress, 4
      optional :bool, :multiplePaypalInstrumentsSupported, 5
    end

    class FileMetadataProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.FileMetadataProto"
    ...
    class GetAddressSnippetRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetAddressSnippetRequestProto"

      optional ::MightyApk::ProtocolBuffers::EncryptedSubscriberInfo, :encryptedSubscriberInfo, 1
    end

    class GetAddressSnippetResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetAddressSnippetResponseProto"

      optional :string, :addressSnippet, 1
    end

    class GetAssetRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetAssetRequestProto"
    ...
    class GetAssetResponseProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetAssetResponseProto"

      # nested messages
      class InstallAsset < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.GetAssetResponseProto.InstallAsset"
      ...
      optional ::MightyApk::ProtocolBuffers::GetAssetResponseProto::InstallAsset, :installasset, 1, :group => true
      repeated ::MightyApk::ProtocolBuffers::FileMetadataProto, :additionalFile, 15
    end

    class GetCarrierInfoRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetCarrierInfoRequestProto"

    end

    class GetCarrierInfoResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetCarrierInfoResponseProto"
    ...
    class GetCategoriesRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetCategoriesRequestProto"

      optional :bool, :prefetchPromoData, 1
    end

    class GetCategoriesResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetCategoriesResponseProto"

      repeated ::MightyApk::ProtocolBuffers::CategoryProto, :categories, 1
    end

    class GetImageRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetImageRequestProto"
    ...
    class GetImageResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetImageResponseProto"
    ...
    class GetMarketMetadataRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetMarketMetadataRequestProto"

      optional :int64, :lastRequestTime, 1
      optional ::MightyApk::ProtocolBuffers::DeviceConfigurationProto, :deviceConfiguration, 2
    ...
    class GetMarketMetadataResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetMarketMetadataResponseProto"

      optional :int32, :latestClientVersionCode, 1
      optional :string, :latestClientUrl, 2
      optional :bool, :paidAppsEnabled, 3
      repeated ::MightyApk::ProtocolBuffers::BillingParameterProto, :billingParameter, 4
    ...
    class GetSubCategoriesRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetSubCategoriesRequestProto"
    ...
    class GetSubCategoriesResponseProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.GetSubCategoriesResponseProto"

      # nested messages
      class SubCategory < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.GetSubCategoriesResponseProto.SubCategory"

        optional :string, :subCategoryDisplay, 2
        optional :string, :subCategoryId, 3
      end

      repeated ::MightyApk::ProtocolBuffers::GetSubCategoriesResponseProto::SubCategory, :subcategory, 1, :group => true
    end

    class InAppPurchaseInformationRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.InAppPurchaseInformationRequestProto"

      optional ::MightyApk::ProtocolBuffers::SignatureHashProto, :signatureHash, 1
    ...
    class InAppPurchaseInformationResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.InAppPurchaseInformationResponseProto"

      optional ::MightyApk::ProtocolBuffers::SignedDataProto, :signedResponse, 1
      repeated ::MightyApk::ProtocolBuffers::StatusBarNotificationProto, :statusBarNotification, 2
      optional ::MightyApk::ProtocolBuffers::PurchaseResultProto, :purchaseResult, 3
    end

    class InAppRestoreTransactionsRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.InAppRestoreTransactionsRequestProto"
    ...
    class InAppRestoreTransactionsResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.InAppRestoreTransactionsResponseProto"

      optional ::MightyApk::ProtocolBuffers::SignedDataProto, :signedResponse, 1
      optional ::MightyApk::ProtocolBuffers::PurchaseResultProto, :purchaseResult, 2
    end

    class ModifyCommentRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ModifyCommentRequestProto"

      optional :string, :assetId, 1
      optional ::MightyApk::ProtocolBuffers::ExternalCommentProto, :comment, 2
    ...
    class ModifyCommentResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ModifyCommentResponseProto"

    end

    class PaypalCountryInfoProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalCountryInfoProto"
    ...
    class PaypalCreateAccountRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalCreateAccountRequestProto"

      optional :string, :firstName, 1
      optional :string, :lastName, 2
      optional ::MightyApk::ProtocolBuffers::AddressProto, :address, 3
      optional :string, :birthDate, 4
    end

    class PaypalCreateAccountResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalCreateAccountResponseProto"

      optional :string, :createAccountKey, 1
    end

    class PaypalCredentialsProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalCredentialsProto"
    ...
    class PaypalMassageAddressRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalMassageAddressRequestProto"

      optional ::MightyApk::ProtocolBuffers::AddressProto, :address, 1
    end

    class PaypalMassageAddressResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalMassageAddressResponseProto"

      optional ::MightyApk::ProtocolBuffers::AddressProto, :address, 1
    end

    class PaypalPreapprovalCredentialsRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalPreapprovalCredentialsRequestProto"
    ...
    class PaypalPreapprovalCredentialsResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalPreapprovalCredentialsResponseProto"
    ...
    class PaypalPreapprovalDetailsRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalPreapprovalDetailsRequestProto"
    ...
    class PaypalPreapprovalDetailsResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalPreapprovalDetailsResponseProto"

      optional :string, :paypalEmail, 1
      optional ::MightyApk::ProtocolBuffers::AddressProto, :address, 2
    end

    class PaypalPreapprovalRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalPreapprovalRequestProto"

    end

    class PaypalPreapprovalResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PaypalPreapprovalResponseProto"

      optional :string, :preapprovalKey, 1
    end

    class PendingNotificationsProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PendingNotificationsProto"

      repeated ::MightyApk::ProtocolBuffers::DataMessageProto, :notification, 1
      optional :int64, :nextCheckMillis, 2
    end

    class PrefetchedBundleProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PrefetchedBundleProto"

      optional ::MightyApk::ProtocolBuffers::SingleRequestProto, :request, 1
      optional ::MightyApk::ProtocolBuffers::SingleResponseProto, :response, 2
    end

    class PurchaseCartInfoProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseCartInfoProto"
    ...
    class PurchaseInfoProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseInfoProto"
      ...
      class BillingInstruments < ::ProtocolBuffers::Message
        ...
        set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseInfoProto.BillingInstruments"

        # nested messages
        class BillingInstrument < ::ProtocolBuffers::Message
          set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseInfoProto.BillingInstruments.BillingInstrument"
        ...
        repeated ::MightyApk::ProtocolBuffers::PurchaseInfoProto::BillingInstruments::BillingInstrument, :billinginstrument, 4, :group => true
        optional :string, :defaultBillingInstrumentId, 8
      end

      optional :string, :transactionId, 1
      optional ::MightyApk::ProtocolBuffers::PurchaseCartInfoProto, :cartInfo, 2
      optional ::MightyApk::ProtocolBuffers::PurchaseInfoProto::BillingInstruments, :billinginstruments, 3, :group => true
    ...
    class PurchaseMetadataRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseMetadataRequestProto"
    ...
    class PurchaseMetadataResponseProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseMetadataResponseProto"
      ...
      class Countries < ::ProtocolBuffers::Message
        ...
        set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseMetadataResponseProto.Countries"
        ...
        class Country < ::ProtocolBuffers::Message
          ...
          set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseMetadataResponseProto.Countries.Country"

          # nested messages
          class InstrumentAddressSpec < ::ProtocolBuffers::Message
            set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseMetadataResponseProto.Countries.Country.InstrumentAddressSpec"

            optional :int32, :instrumentFamily, 8
            optional ::MightyApk::ProtocolBuffers::BillingAddressSpec, :billingAddressSpec, 9
          end

          optional :string, :countryCode, 3
          optional :string, :countryName, 4
          optional ::MightyApk::ProtocolBuffers::PaypalCountryInfoProto, :paypalCountryInfo, 5
          optional :bool, :allowsReducedBillingAddress, 6
          repeated ::MightyApk::ProtocolBuffers::PurchaseMetadataResponseProto::Countries::Country::InstrumentAddressSpec, :instrumentaddressspec, 7, :group => true
        end

        repeated ::MightyApk::ProtocolBuffers::PurchaseMetadataResponseProto::Countries::Country, :country, 2, :group => true
      end

      optional ::MightyApk::ProtocolBuffers::PurchaseMetadataResponseProto::Countries, :countries, 1, :group => true
    end

    class PurchaseOrderRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseOrderRequestProto"
      ...
      optional ::MightyApk::ProtocolBuffers::CarrierBillingCredentialsProto, :carrierBillingCredentials, 6
      optional :string, :existingOrderId, 7
      optional :int32, :billingInstrumentType, 8
      optional :string, :billingParametersId, 9
      optional ::MightyApk::ProtocolBuffers::PaypalCredentialsProto, :paypalCredentials, 10
      optional ::MightyApk::ProtocolBuffers::RiskHeaderInfoProto, :riskHeaderInfo, 11
      optional :int32, :productType, 12
      optional ::MightyApk::ProtocolBuffers::SignatureHashProto, :signatureHash, 13
      optional :string, :developerPayload, 14
    end

    class PurchaseOrderResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseOrderResponseProto"

      optional :int32, :deprecatedResultCode, 1
      optional ::MightyApk::ProtocolBuffers::PurchaseInfoProto, :purchaseInfo, 2
      optional ::MightyApk::ProtocolBuffers::ExternalAssetProto, :asset, 3
      optional ::MightyApk::ProtocolBuffers::PurchaseResultProto, :purchaseResult, 4
    end
    ...
    class PurchasePostRequestProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchasePostRequestProto"

      # nested messages
      class BillingInstrumentInfo < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchasePostRequestProto.BillingInstrumentInfo"

        optional :string, :billingInstrumentId, 5
        optional ::MightyApk::ProtocolBuffers::ExternalCreditCard, :creditCard, 6
        optional ::MightyApk::ProtocolBuffers::ExternalCarrierBillingInstrumentProto, :carrierInstrument, 9
        optional ::MightyApk::ProtocolBuffers::ExternalPaypalInstrumentProto, :paypalInstrument, 10
      end

      optional :string, :gaiaAuthToken, 1
      optional :string, :assetId, 2
      optional :string, :transactionId, 3
      optional ::MightyApk::ProtocolBuffers::PurchasePostRequestProto::BillingInstrumentInfo, :billinginstrumentinfo, 4, :group => true
    ...
    class PurchasePostResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchasePostResponseProto"
      ...
      optional ::MightyApk::ProtocolBuffers::PurchaseResultProto, :purchaseResult, 8
    end

    class PurchaseProductRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseProductRequestProto"

      optional :int32, :productType, 1
      optional :string, :productId, 2
      optional ::MightyApk::ProtocolBuffers::SignatureHashProto, :signatureHash, 3
    end

    class PurchaseProductResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseProductResponseProto"
    ...
    class PurchaseResultProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.PurchaseResultProto"
    ...
    class QuerySuggestionProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.QuerySuggestionProto"
    ...
    class QuerySuggestionRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.QuerySuggestionRequestProto"
    ...
    class QuerySuggestionResponseProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.QuerySuggestionResponseProto"

      # nested messages
      class Suggestion < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.QuerySuggestionResponseProto.Suggestion"

        optional ::MightyApk::ProtocolBuffers::AppSuggestionProto, :appSuggestion, 2
        optional ::MightyApk::ProtocolBuffers::QuerySuggestionProto, :querySuggestion, 3
      end

      repeated ::MightyApk::ProtocolBuffers::QuerySuggestionResponseProto::Suggestion, :suggestion, 1, :group => true
    ...
    class RateCommentRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RateCommentRequestProto"
    ...
    class RateCommentResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RateCommentResponseProto"

    end

    class ReconstructDatabaseRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ReconstructDatabaseRequestProto"

      optional :bool, :retrieveFullHistory, 1
    end

    class ReconstructDatabaseResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ReconstructDatabaseResponseProto"

      repeated ::MightyApk::ProtocolBuffers::AssetIdentifierProto, :asset, 1
    end

    class RefundRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RefundRequestProto"

      optional :string, :assetId, 1
    end

    class RefundResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RefundResponseProto"

      optional :int32, :result, 1
      optional ::MightyApk::ProtocolBuffers::ExternalAssetProto, :asset, 2
      optional :string, :resultDetail, 3
    end

    class RemoveAssetRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RemoveAssetRequestProto"

      optional :string, :assetId, 1
    end

    class RequestPropertiesProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RequestPropertiesProto"
    ...
    class RequestProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RequestProto"

      # nested messages
      class Request < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.RequestProto.Request"

        optional ::MightyApk::ProtocolBuffers::RequestSpecificPropertiesProto, :requestSpecificProperties, 3
        optional ::MightyApk::ProtocolBuffers::AssetsRequestProto, :assetRequest, 4
        optional ::MightyApk::ProtocolBuffers::CommentsRequestProto, :commentsRequest, 5
        optional ::MightyApk::ProtocolBuffers::ModifyCommentRequestProto, :modifyCommentRequest, 6
        optional ::MightyApk::ProtocolBuffers::PurchasePostRequestProto, :purchasePostRequest, 7
        optional ::MightyApk::ProtocolBuffers::PurchaseOrderRequestProto, :purchaseOrderRequest, 8
        optional ::MightyApk::ProtocolBuffers::ContentSyncRequestProto, :contentSyncRequest, 9
        optional ::MightyApk::ProtocolBuffers::GetAssetRequestProto, :getAssetRequest, 10
        optional ::MightyApk::ProtocolBuffers::GetImageRequestProto, :getImageRequest, 11
        optional ::MightyApk::ProtocolBuffers::RefundRequestProto, :refundRequest, 12
        optional ::MightyApk::ProtocolBuffers::PurchaseMetadataRequestProto, :purchaseMetadataRequest, 13
        optional ::MightyApk::ProtocolBuffers::GetSubCategoriesRequestProto, :subCategoriesRequest, 14
        optional ::MightyApk::ProtocolBuffers::UninstallReasonRequestProto, :uninstallReasonRequest, 16
        optional ::MightyApk::ProtocolBuffers::RateCommentRequestProto, :rateCommentRequest, 17
        optional ::MightyApk::ProtocolBuffers::CheckLicenseRequestProto, :checkLicenseRequest, 18
        optional ::MightyApk::ProtocolBuffers::GetMarketMetadataRequestProto, :getMarketMetadataRequest, 19
        optional ::MightyApk::ProtocolBuffers::GetCategoriesRequestProto, :getCategoriesRequest, 21
        optional ::MightyApk::ProtocolBuffers::GetCarrierInfoRequestProto, :getCarrierInfoRequest, 22
        optional ::MightyApk::ProtocolBuffers::RemoveAssetRequestProto, :removeAssetRequest, 23
        optional ::MightyApk::ProtocolBuffers::RestoreApplicationsRequestProto, :restoreApplicationsRequest, 24
        optional ::MightyApk::ProtocolBuffers::QuerySuggestionRequestProto, :querySuggestionRequest, 25
        optional ::MightyApk::ProtocolBuffers::BillingEventRequestProto, :billingEventRequest, 26
        optional ::MightyApk::ProtocolBuffers::PaypalPreapprovalRequestProto, :paypalPreapprovalRequest, 27
        optional ::MightyApk::ProtocolBuffers::PaypalPreapprovalDetailsRequestProto, :paypalPreapprovalDetailsRequest, 28
        optional ::MightyApk::ProtocolBuffers::PaypalCreateAccountRequestProto, :paypalCreateAccountRequest, 29
        optional ::MightyApk::ProtocolBuffers::PaypalPreapprovalCredentialsRequestProto, :paypalPreapprovalCredentialsRequest, 30
        optional ::MightyApk::ProtocolBuffers::InAppRestoreTransactionsRequestProto, :inAppRestoreTransactionsRequest, 31
        optional ::MightyApk::ProtocolBuffers::InAppPurchaseInformationRequestProto, :inAppPurchaseInformationRequest, 32
        optional ::MightyApk::ProtocolBuffers::CheckForNotificationsRequestProto, :checkForNotificationsRequest, 33
        optional ::MightyApk::ProtocolBuffers::AckNotificationsRequestProto, :ackNotificationsRequest, 34
        optional ::MightyApk::ProtocolBuffers::PurchaseProductRequestProto, :purchaseProductRequest, 35
        optional ::MightyApk::ProtocolBuffers::ReconstructDatabaseRequestProto, :reconstructDatabaseRequest, 36
        optional ::MightyApk::ProtocolBuffers::PaypalMassageAddressRequestProto, :paypalMassageAddressRequest, 37
        optional ::MightyApk::ProtocolBuffers::GetAddressSnippetRequestProto, :getAddressSnippetRequest, 38
      end

      optional ::MightyApk::ProtocolBuffers::RequestPropertiesProto, :requestProperties, 1
      repeated ::MightyApk::ProtocolBuffers::RequestProto::Request, :request, 2, :group => true
    end

    class RequestSpecificPropertiesProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RequestSpecificPropertiesProto"

      optional :string, :ifNoneMatch, 1
    end

    class ResponsePropertiesProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ResponsePropertiesProto"
      ...
      repeated ::MightyApk::ProtocolBuffers::InputValidationError, :errorInputField, 8
    end
    ...
    class ResponseProto < ::ProtocolBuffers::Message
      ...
      set_fully_qualified_name "MightyApk.ProtocolBuffers.ResponseProto"

      # nested messages
      class Response < ::ProtocolBuffers::Message
        set_fully_qualified_name "MightyApk.ProtocolBuffers.ResponseProto.Response"

        optional ::MightyApk::ProtocolBuffers::ResponsePropertiesProto, :responseProperties, 2
        optional ::MightyApk::ProtocolBuffers::AssetsResponseProto, :assetsResponse, 3
        optional ::MightyApk::ProtocolBuffers::CommentsResponseProto, :commentsResponse, 4
        optional ::MightyApk::ProtocolBuffers::ModifyCommentResponseProto, :modifyCommentResponse, 5
        optional ::MightyApk::ProtocolBuffers::PurchasePostResponseProto, :purchasePostResponse, 6
        optional ::MightyApk::ProtocolBuffers::PurchaseOrderResponseProto, :purchaseOrderResponse, 7
        optional ::MightyApk::ProtocolBuffers::ContentSyncResponseProto, :contentSyncResponse, 8
        optional ::MightyApk::ProtocolBuffers::GetAssetResponseProto, :getAssetResponse, 9
        optional ::MightyApk::ProtocolBuffers::GetImageResponseProto, :getImageResponse, 10
        optional ::MightyApk::ProtocolBuffers::RefundResponseProto, :refundResponse, 11
        optional ::MightyApk::ProtocolBuffers::PurchaseMetadataResponseProto, :purchaseMetadataResponse, 12
        optional ::MightyApk::ProtocolBuffers::GetSubCategoriesResponseProto, :subCategoriesResponse, 13
        optional ::MightyApk::ProtocolBuffers::UninstallReasonResponseProto, :uninstallReasonResponse, 15
        optional ::MightyApk::ProtocolBuffers::RateCommentResponseProto, :rateCommentResponse, 16
        optional ::MightyApk::ProtocolBuffers::CheckLicenseResponseProto, :checkLicenseResponse, 17
        optional ::MightyApk::ProtocolBuffers::GetMarketMetadataResponseProto, :getMarketMetadataResponse, 18
        repeated ::MightyApk::ProtocolBuffers::PrefetchedBundleProto, :prefetchedBundle, 19
        optional ::MightyApk::ProtocolBuffers::GetCategoriesResponseProto, :getCategoriesResponse, 20
        optional ::MightyApk::ProtocolBuffers::GetCarrierInfoResponseProto, :getCarrierInfoResponse, 21
        optional ::MightyApk::ProtocolBuffers::RestoreApplicationsResponseProto, :restoreApplicationResponse, 23
        optional ::MightyApk::ProtocolBuffers::QuerySuggestionResponseProto, :querySuggestionResponse, 24
        optional ::MightyApk::ProtocolBuffers::BillingEventResponseProto, :billingEventResponse, 25
        optional ::MightyApk::ProtocolBuffers::PaypalPreapprovalResponseProto, :paypalPreapprovalResponse, 26
        optional ::MightyApk::ProtocolBuffers::PaypalPreapprovalDetailsResponseProto, :paypalPreapprovalDetailsResponse, 27
        optional ::MightyApk::ProtocolBuffers::PaypalCreateAccountResponseProto, :paypalCreateAccountResponse, 28
        optional ::MightyApk::ProtocolBuffers::PaypalPreapprovalCredentialsResponseProto, :paypalPreapprovalCredentialsResponse, 29
        optional ::MightyApk::ProtocolBuffers::InAppRestoreTransactionsResponseProto, :inAppRestoreTransactionsResponse, 30
        optional ::MightyApk::ProtocolBuffers::InAppPurchaseInformationResponseProto, :inAppPurchaseInformationResponse, 31
        optional ::MightyApk::ProtocolBuffers::CheckForNotificationsResponseProto, :checkForNotificationsResponse, 32
        optional ::MightyApk::ProtocolBuffers::AckNotificationsResponseProto, :ackNotificationsResponse, 33
        optional ::MightyApk::ProtocolBuffers::PurchaseProductResponseProto, :purchaseProductResponse, 34
        optional ::MightyApk::ProtocolBuffers::ReconstructDatabaseResponseProto, :reconstructDatabaseResponse, 35
        optional ::MightyApk::ProtocolBuffers::PaypalMassageAddressResponseProto, :paypalMassageAddressResponse, 36
        optional ::MightyApk::ProtocolBuffers::GetAddressSnippetResponseProto, :getAddressSnippetResponse, 37
      end

      repeated ::MightyApk::ProtocolBuffers::ResponseProto::Response, :response, 1, :group => true
      optional ::MightyApk::ProtocolBuffers::PendingNotificationsProto, :pendingNotifications, 38
    end

    class RestoreApplicationsRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RestoreApplicationsRequestProto"

      optional :string, :backupAndroidId, 1
      optional :string, :tosVersion, 2
      optional ::MightyApk::ProtocolBuffers::DeviceConfigurationProto, :deviceConfiguration, 3
    end

    class RestoreApplicationsResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RestoreApplicationsResponseProto"

      repeated ::MightyApk::ProtocolBuffers::GetAssetResponseProto, :asset, 1
    end

    class RiskHeaderInfoProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.RiskHeaderInfoProto"

      optional :string, :hashedDeviceInfo, 1
    end

    class SignatureHashProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SignatureHashProto"
    ...
    class SignedDataProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SignedDataProto"
    ...
    class SingleRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SingleRequestProto"
      ...
      optional ::MightyApk::ProtocolBuffers::PaypalPreapprovalCredentialsRequestProto, :paypalPreapprovalCredentialsRequest, 30
      optional ::MightyApk::ProtocolBuffers::InAppRestoreTransactionsRequestProto, :inAppRestoreTransactionsRequest, 31
      optional ::MightyApk::ProtocolBuffers::InAppPurchaseInformationRequestProto, :getInAppPurchaseInformationRequest, 32
      optional ::MightyApk::ProtocolBuffers::CheckForNotificationsRequestProto, :checkForNotificationsRequest, 33
      optional ::MightyApk::ProtocolBuffers::AckNotificationsRequestProto, :ackNotificationsRequest, 34
      optional ::MightyApk::ProtocolBuffers::PurchaseProductRequestProto, :purchaseProductRequest, 35
      optional ::MightyApk::ProtocolBuffers::ReconstructDatabaseRequestProto, :reconstructDatabaseRequest, 36
    ...
    class SingleResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.SingleResponseProto"
      ...
      optional ::MightyApk::ProtocolBuffers::PaypalPreapprovalCredentialsResponseProto, :paypalPreapprovalCredentialsResponse, 29
      optional ::MightyApk::ProtocolBuffers::InAppRestoreTransactionsResponseProto, :inAppRestoreTransactionsResponse, 30
      optional ::MightyApk::ProtocolBuffers::InAppPurchaseInformationResponseProto, :getInAppPurchaseInformationResponse, 31
      optional ::MightyApk::ProtocolBuffers::CheckForNotificationsResponseProto, :checkForNotificationsResponse, 32
      optional ::MightyApk::ProtocolBuffers::AckNotificationsResponseProto, :ackNotificationsResponse, 33
      optional ::MightyApk::ProtocolBuffers::PurchaseProductResponseProto, :purchaseProductResponse, 34
      optional ::MightyApk::ProtocolBuffers::ReconstructDatabaseResponseProto, :reconstructDatabaseResponse, 35
    ...
    class StatusBarNotificationProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.StatusBarNotificationProto"
    ...
    class UninstallReasonRequestProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.UninstallReasonRequestProto"
    ...
    class UninstallReasonResponseProto < ::ProtocolBuffers::Message
      set_fully_qualified_name "MightyApk.ProtocolBuffers.UninstallReasonResponseProto"
