...
App companies link iOS publishers and Android publishers. An app company can have many iOS publishers and Android publishers.

<aside class="warning">
App company endpoints are currently in Beta. Linking publishers to companies is challenging, so some data may not be accurate.
</aside>

## Get the company given the iOS or Android publisher

> Example: Retrieve the latest information about Shazam (for iOS)

```bash
curl "https://api.mightysignal.com/app_company?ios_publisher_id=207911"
    -H "MIGHTYSIGNAL-TOKEN: <your-api-token>"
```
...
--------- | -----------
ios_publisher_id | The iOS publisher ID
android_publisher_id | The Android publisher ID

<aside class="notice">
Pass the <code>ios_publisher_id</code> key or the <code>android_publisher_id</code> key, but not both simulatenously.
</aside>
...
Key | Description
--- | -----------
android_publishers.websites | An array of all websites of all Android apps of the publisher
android_publishers.name | Name of the Android publisher
android_publishers.platform | `android`
android_publishers.id | The MightySignal ID of the Android publisher
ios_publishers.websites | An array of all websites of all iOS apps of the publisher
ios_publishers.name | Name of the iOS publisher
ios_publishers.platform | `ios`
ios_publishers.id | The MightySignal ID of the iOS publisher
name | Name of the company
id | MightySignal ID of the company
