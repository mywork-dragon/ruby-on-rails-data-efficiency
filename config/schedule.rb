...
every :day, :at => '11:50pm', roles: [:scraper_master] do
  command "cd /home/deploy/varys_current && nohup bundle exec rake epf:run_itunes_current RAILS_ENV=production > /home/deploy/epf_run_itunes_current.log &"
end
