...
set :stages, %w(scraper sdk_scraper web staging darth_vader kylo_ren)
...
set :darth_vader_queue, %w(ios_live_scan_test ios_live_scan ios_mass_scan)
set :kylo_ren_queue, %w(no_op)
