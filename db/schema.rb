...
ActiveRecord::Schema.define(version: 20150417225241) do
  ...
  add_index "android_fb_ad_appearances", ["ios_app_id"], name: "index_android_fb_ad_appearances_on_ios_app_id", using: :btree
