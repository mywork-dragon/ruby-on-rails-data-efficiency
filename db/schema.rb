...
ActiveRecord::Schema.define(version: 20150324000708) do
  ...
  add_index "proxies", ["lastUsed"], name: "index_proxies_on_lastUsed", using: :btree
  add_index "proxies", ["privateIp"], name: "index_proxies_on_privateIp", using: :btree
