class AddUniquenessToAndroidSdkCompaniesApkSnapshot < ActiveRecord::Migration
  def change
    ...
    add_index :android_sdk_companies_apk_snapshots, [:apk_snapshot_id, :android_sdk_company_id], :unique => true, name: 'index_unique_apk_snapshot_id_android_sdk_company_id'
