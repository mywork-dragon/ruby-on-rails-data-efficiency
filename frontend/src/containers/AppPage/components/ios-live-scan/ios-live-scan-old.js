      ...
      sdkLiveScanService.checkForIosSdks(appId)
        .success((data) => {
          ...
          if (data.error_code != null) {
            ...
            sdkLiveScanService.iosLiveScanHiddenSdksAnalytics($stateParams.platform, iosAppId, data.error_code, errorCodeMessages[data.error_code]);
          }
          ...
          .success((data) => {
            ...
            switch (data.status) {
              ...
              case 11:
                ...
                if (iosLiveScanCtrl.errorCodeMessage != null) {
                  ...
                  // Failed analytics response - MixPanel & Slacktivity
                  sdkLiveScanService.iosLiveScanFailRequestAnalytics($stateParams.platform, iosAppId, data.status);
                }
            ...
            if ([2, 3, 4, 6].includes(data.status)) {
              ...
              if (data.status < 4) {
                ...
                // Failed analytics response - MixPanel & Slacktivity
                sdkLiveScanService.iosLiveScanHiddenSdksAnalytics($stateParams.platform, iosAppId, data.status, statusCodeMessages[data.status]);
